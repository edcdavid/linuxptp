...
OBJ	= bmc.o clock.o clockadj.o clockcheck.o config.o designated_fsm.o \
 e2e_tc.o fault.o $(FILTERS) fsm.o hash.o interface.o metrics.o monitor.o msg.o phc.o \
 pmc_common.o port.o port_signaling.o pqueue.o print.o ptp4l.o p2p_tc.o rtnl.o \
 $(SECURITY) $(SERVOS) sk.o stats.o tc.o tinyexpr.o $(TRANSP) telecom.o tlv.o tsproc.o \
