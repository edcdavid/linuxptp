...
struct config_item config_tab[] = {
	...
	GLOB_ITEM_STR("metrics_socket", NULL),
	GLOB_ITEM_STR("metrics_filter_clock_summary", NULL),
	GLOB_ITEM_STR("metrics_filter_clock", NULL),
	GLOB_ITEM_STR("metrics_filter_state", NULL),
